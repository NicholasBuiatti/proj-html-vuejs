...
<template>
    <header class="my-bg">
        <!-- Sezione nav bar -->
        <div class="flex row m-0 align-items-center justify-content-center py-3 px-0 w-100 my-fixed"
            ...
            <nav class="col-8 p-0">
                <div class=" flex row m-0 p-0 px-2 w-100 justify-content-center">
                    <div class="dropdown col-1">
                        <button class="btn dropdown-toggle text-light border-none hover" type="button"
                    ...
                    <div class="my-width">
                        <button class="btn  text-light border-none hover" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            TOURNAMENT
                        </button>
                    </div>
                    ...
                    <div class="dropdown col-1">
                        <button class="btn dropdown-toggle text-light border-none" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            BLOG
                        </button>
                        <ul class="dropdown-menu bg-violet">
            ...
            <div class="col-1 flex row justify-content-center m-0 p-0">
                <div class="col-6">
                    <div class="btn-group dropstart">
                        <button type="button" class="btn bg-light my-size shop-zone rounded-5" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="fa-solid fa-magnifying-glass violet-c"></i>
                        </button>
                        <ul class="dropdown-menu transformp m-2">
                            <li><input class="form-control mr-sm-2" type="search" placeholder="Search"
                                    aria-label="Search">
                            </li>
                        </ul>
                    </div>
