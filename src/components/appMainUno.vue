    ...
    <div class=" container_sezione1 ">
        ...
        <div class="sub_container w-100 mt-5 d-flex container">
            ...
            <div class="col-6 d-flex justify-content-center align-items-center flex-column">
                ...
                <p class="m-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magnam, eaque porro aut numquam
                    ad cumque accusamus voluptas, nemo at nesciunt nam in dolor soluta vitae, eum animi consequuntur
                    ipsa ut.</p>
                <ul>
                    <li><i class="fa-regular fa-circle-check me-2 green"></i>Sed porttitor lectus nibh. Proin eget
                        tortor risus.</li>
                    <li><i class="fa-regular fa-circle-check me-2 green"></i>Sed porttitor lectus nibh. Proin eget
                        tortor risus.</li>
                    <li><i class="fa-regular fa-circle-check me-2 green"></i>Sed porttitor lectus nibh. Proin eget
                ...
                <div class="d-flex text-black">
                    <div class="p-3 b me-2 rounded d-flex justify-content-center align-items-center">Discover more <i
                            class="fa-solid fa-arrow-right ms-2"></i></div>
                    <a href="#" class="a rounded-circle d-flex justify-content-center align-items-center"><i
    ...
    <div class="container_sezione2 ">
        <div class="container d-flex flex-wrap">
            <div class="col-6 d-flex flex-column text-light justify-content-center ">
                ...
                <p class="fs-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore, voluptatem. Dolore
                    ipsa eligendi, veritatis aspernatur cumque, pariatur accusamus voluptatem ducimus voluptates
                    molestiae ut quod iure unde consequatur ad optio vero?</p>

            </div>
            <div class="col-6 d-flex flex-wrap">
                <div class="cardGame d-flex align-items-center justify-content-center flex-column m-2 rounded"
                    style="background-color:rgb(10, 169, 110) ; color:rgb(23, 30, 67);">
